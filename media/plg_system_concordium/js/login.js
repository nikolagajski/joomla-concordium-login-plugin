...
var browser_wallet_api_helpers_1 = __webpack_require__(/*! @concordium/browser-wallet-api-helpers */ "./node_modules/@concordium/browser-wallet-api-helpers/lib/concordiumHelpers.min.js");
var axios_1 = __webpack_require__(/*! axios */ "./node_modules/axios/dist/browser/axios.cjs");
var LoginButtons = /** @class */ (function () {
    function LoginButtons(className) {
        // @ts-ignore
        this.buttons = document.getElementsByClassName(className);
    }
    LoginButtons.prototype.apply = function (callback) {
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            console.log('ok fine');
            buttons = new LoginButtons('plg_system_concordium_login_button');
            buttons.apply(function (btn) { return btn.disabled = true; });
            rootUri = Joomla.getOptions('system.paths').rootFull;
            (0, browser_wallet_api_helpers_1.detectConcordiumProvider)()
                ...
                function connect(btn) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            provider
                                .connect()
                                .then(function (accountAddress) { return __awaiter(_this, void 0, void 0, function () {
                                var res, text, signed, res2;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 1:
                                            ...
                                            console.log(res);
                                            text = res.data.data.nonce;
                                            return [4 /*yield*/, provider.signMessage(accountAddress, text)];
                                        case 2:
                                            signed = _a.sent();
                                            return [4 /*yield*/, (0, axios_1.default)({
                                                    method: 'post',
